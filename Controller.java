package sample;  /*Java is used to group related classes. Think of it as a folder in a file directory
...
public class Controller implements Initializable {
    ...
    @FXML
    private ListView<Employee> employeeListView; //when you type this in it will auto to swing which you need to delete / you want import javafx.scene.control.ListView;

    @FXML
    private TextField firstNameTextField; //in sample.fxml
